...
When /^Я перехожу на страницу просмотра найденной компании$/ do
  page.find(:xpath, "//a[@href='#{company_path(@company)}'][text()='#{@company.title}']").click
end
...
When /^Я нахожусь на странице просмотра найденной компании после выполнения поиска$/ do
  step 'Я выполняю поиск компаний'
  step 'Я перехожу на страницу просмотра найденной компании'
end
