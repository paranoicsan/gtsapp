Feature: К филиалу может быть привязано множество веб-сайтов.
  ...
  Scenario: Пользователь может добавить несколько веб-сайтов к филиалу
    ...
    And Я активирую закладку "Веб-сайты"
  ...
  @javascript
  Scenario: Один и тот же веб-сайт можно добавить к разным филиалам
  ...
  Scenario: Пользователь не может удалить веб-сайт из филиала
    ...
    And Я активирую закладку "Веб-сайты"
    Then Я не вижу ссылки для удаления филиалов
  ...
  Scenario: Пользователь может видеть все адреса веб-сайтов на странице компании
    Given Я авторизован в системе
    When Существует компания с 3 веб-сайтами
    Then Я вижу все адреса веб-сайтов на странице компании
