Feature: У компании может быть множество филиалов
  ...
  Scenario: Пользователь не может сохранить филиал без ввода фактического названия
    ...
    When Я нахожусь на странице создания филиала
    Then Я не могу сохранить филиал без фактического названия

  @javascript
  Scenario: Пользователь не может сохранить филиал без ввода юридического названия
    Given Я - "агент", авторизованный в системе
    When Я нахожусь на странице создания филиала
    Then Я не могу сохранить филиал без юридического названия
  ...
  Scenario: Первый создаваемый филиал всегда помечается как основной
    ...
    And "Филиал рогов" для компании "Рога и копыта" является главным
  ...
  Scenario: Пользователь может выбирать основной филиал на странице компании
    ...
    Then "Филиал рогов 2" для компании "Рога и копыта" является главным
  ...
  Scenario: Головной офис всегд находится на верхней строке в списке адресов.
    ...
    And Существуют следующие филиалы для компании "Рога и копыта"
      ...
      | ООО       | Филиал рогов   | Юр. имя филиала рогов   |
      | МУП       | Филиал рогов 2 | Юр. имя филиала рогов 2 |
      | ООО       | Филиал рогов 3 | Юр. имя филиала рогов 3 |
      | МУП       | Филиал рогов 4 | Юр. имя филиала рогов 4 |
    When Я нахожусь на странице компании "Рога и копыта"
    And Я выбираю в качестве головного филиал с факт. названием "Филиал рогов 3"
    Then Филиал с факт. название "Филиал рогов 3" находится в первом ряду списка