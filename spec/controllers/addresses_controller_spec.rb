...
describe AddressesController do
  ...
  describe "GET new" do
    it "assigns a new address as @address" do
      get :new, {:branch_id => 1}, valid_session
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved address as @address" do
        ...
        post :create, {:address => {}, :branch_id => 1}, valid_session
        assigns(:address).should be_a_new(Address)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested address" do
        ...
        Address.any_instance.should_receive(:update_attributes).with({:these.to_s => 'params'})
  ...
  describe "DELETE destroy" do
    it "destroys the requested address" do
      address = Address.create! valid_attributes
      expect {
        delete :destroy, {:id => address.to_param, :branch_id => 1}, valid_session
      }.to change(Address, :count).by(-1)
    end
    ...
    it "redirects to the addresses list" do
      ...
      delete :destroy, {:id => address.to_param, :branch_id => 1}, valid_session
      #noinspection RubyResolve
      response.should redirect_to(branch_addresses_url(1))
    end
  end
