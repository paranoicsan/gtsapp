...
describe BranchesController do
  ...
  describe "GET show" do
    it "assigns the requested branch as @branch" do
      branch = Branch.create! valid_attributes
      get :show, {:id => branch.to_param, :company_id => 1}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested branch as @branch" do
      branch = Branch.create! valid_attributes
      get :edit, {:id => branch.to_param, :company_id => 1}, valid_session
      assigns(:branch).should eq(branch)
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested branch" do
        ...
        Branch.any_instance.should_receive(:update_attributes).with({:these.to_s => 'params'})
        put :update, {:id => branch.to_param, :branch => {:these => 'params'}, :company_id => 1}, valid_session
      end

      it "assigns the requested branch as @branch" do
        branch = Branch.create! valid_attributes
        put :update, {:id => branch.to_param, :branch => valid_attributes, :company_id => 1}, valid_session
        assigns(:branch).should eq(branch)
      end
    ...
    describe "with invalid params" do
      it "assigns the branch as @branch" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Branch.any_instance.stub(:save).and_return(false)
        put :update, {:id => branch.to_param, :branch => {}, :company_id => 1}, valid_session
        assigns(:branch).should eq(branch)
      end
