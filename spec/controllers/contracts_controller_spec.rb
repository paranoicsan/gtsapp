...
describe ContractsController do
  ...
  before(:each) do
    ...
    Company.stub(:find).with("1").and_return(@company) # подмена родительской компании
  end
  ...
  describe "GET show" do
    it "assigns the requested contract as @contract" do
      contract = Contract.create! valid_attributes
      get :show, {:id => contract.to_param, :company_id => 1}, valid_session
  ...
  describe "GET edit" do
    ...
    it "assigns the requested contract as @contract" do
      contract = Contract.create! valid_attributes
      get :edit, {:id => contract.to_param, :company_id => 1}, valid_session
      assigns(:contract).should eq(contract)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "creates a new Contract" do
        expect {
          post :create, {:contract => valid_attributes, :company_id => 1}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contract as @contract" do
        ...
        post :create, {:contract => {}, :company_id => 1}, valid_session
        assigns(:contract).should be_a_new(Contract)
      end
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested contract" do
        ...
        Contract.any_instance.should_receive(:update_attributes).with({:these.to_s => 'params'})
        put :update, {:id => contract.to_param, :contract => {:these => 'params'}, :company_id => 1}, valid_session
      end

      it "assigns the requested contract as @contract" do
        contract = Contract.create! valid_attributes
        put :update, {:id => contract.to_param, :contract => valid_attributes, :company_id => 1}, valid_session
        assigns(:contract).should eq(contract)
      end
    ...
    describe "with invalid params" do
      it "assigns the contract as @contract" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contract.any_instance.stub(:save).and_return(false)
        put :update, {:id => contract.to_param, :contract => {}, :company_id => 1}, valid_session
        assigns(:contract).should eq(contract)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "destroys the requested contract" do
      contract = Contract.create! valid_attributes
      expect {
        delete :destroy, {:id => contract.to_param, :company_id => 1}, valid_session
      }.to change(Contract, :count).by(-1)
    end
